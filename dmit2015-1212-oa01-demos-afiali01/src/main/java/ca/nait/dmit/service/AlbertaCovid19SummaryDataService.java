    ...
    public AlbertaCovid19SummaryDataService() throws IOException {
        try(var reader = new BufferedReader(new InputStreamReader(
            ...
            while((line = reader.readLine()) != null){
                ...
                lineData.setDataReported(LocalDate.parse(values[1], dataFormatter));
                lineData.setNumberOfLabsTests(Integer.parseInt(values[2]));
                ...
                lineData.setPercentOfPositivity(Double.parseDouble(values[12]));
